<?php
class model_schema extends abstract_model{
	
	protected $sClassRow='row_schema';
	
	protected $sTable='schema';
...
class row_schema extends abstract_row{
	
	protected $sClassModel='model_schema';
